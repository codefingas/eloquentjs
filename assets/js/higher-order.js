...
/**END OF EXCERCISE TWO */


/**FUNCTION FOR WRITING THE DOMINANT WRITING DIRECTION OF A SCRIPT */
...
function countsBy(item, groupName) {
    let known,
        ...
        if(known == -1) {
            counts.push({name, count : 1});//this creates a new element if the item is not known
        } else {
            counts[known].count++;
        }
